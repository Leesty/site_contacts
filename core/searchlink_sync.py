...
проставляется отдельным скриптом):
    Чат    : только Варвара +10 — с каждого клиента менеджера БЕЗ рефовода
             (правило владельца 2026-07-21; раньше это фи шло за созвон).
    Созвон  (всего 150): с рефоводом → менеджер 100 / рефовод 50 (рефовод
                         получает % только если аккредитован — иначе milestone);
                         без рефовода → менеджер 150.
    Сделка  (всего 4000, за вычетом РЕАЛЬНО выплаченного созвона):
