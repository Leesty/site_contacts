...
class User(AbstractUser):
    ...
    # Право работать с воронкой холодных контактов и сдавать отчёты «Прозвон».
    # Выдаётся главным админом точечно (как и group_reports), с регистрацией
    # подадмина в windowgram чтобы напоминашка реагировала на его команды.
