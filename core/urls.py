...
urlpatterns = [
    ...
    path("partner/ref-rates/", views_partner.partner_ref_rates, name="partner_ref_rates"),
    ...
    # JS-пинг «страницу открыл живой человек» — ставится ДО catch-all ниже.
    path("s/<str:code>/hit/", views_search.search_link_hit, name="search_link_hit"),
    ...
    path("api/cron/poll-incoming-calls/", views_support_admin.zvonok_poll_cron, name="zvonok_poll_cron"),
